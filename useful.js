// Dayz code to create the emojimenu
  ...
  //       emojiListContainer.appendChild(currentRow);
  //     }

  //     const emojiDiv = document.createElement("div");
  //     emojiDiv.innerHTML = emoji;
  //     emojiDiv.addEventListener("click", (event) => {
  //       input.value = emoji;
  //       emojiListDiv.style.display = "none";
  //     });
  //     currentRow.appendChild(emojiDiv);
  //   });

  //   return emojiListContainer;
  // }